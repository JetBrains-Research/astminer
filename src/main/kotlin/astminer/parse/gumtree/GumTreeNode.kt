...
class GumTreeNode(val wrappedNode: Tree, override var parent: GumTreeNode?) :
...
fun wrapGumTreeNode(treeContext: TreeContext): GumTreeNode = GumTreeNode(treeContext.root, null)
