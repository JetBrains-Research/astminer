...
class TreeSitterJavaMethodSplitterTest {
    ...
    companion object {
        ...
        private val functionSplitter = TreeSitterJavaFunctionSplitter()
        val parser = TreeSitterJavaParser()
        var functionInfos: Collection<FunctionInfo<SimpleNode>> = listOf()
