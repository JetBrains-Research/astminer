...
class FuzzyCppParserTest {
    ...
    fun testNodeIsNotNull() {
        ...
        val file = File("src/test/resources/testData/fuzzy/test.cpp")
    ...
    fun testInputStreamParsing() {
        val folder = File("src/test/resources/testData/fuzzy/")
    ...
    fun testPreprocessingProject() {
        val projectRoot = File("src/test/resources/testData/examples/cpp")
        val preprocessedRoot = File("src/test/resources/testData/examples/preprocessed")
