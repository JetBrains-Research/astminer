...
class GumTreeMethodSplitterTest {
    ...
    fun testMethodExtraction1() {
        val methodInfos = createAndSplitTree("gumTreeMethodSplitter/1.java")
    ...
    fun testMethodExtraction2() {
        val methodInfos = createAndSplitTree("gumTreeMethodSplitter/2.java")
    ...
    fun testMethodExtraction3() {
        val methodInfos = createAndSplitTree("gumTreeMethodSplitter/3.java")
    ...
    fun testMethodExtraction4() {
        val methodInfos = createAndSplitTree("gumTreeMethodSplitter/4.java")
