...
class TreeFeatureTest {
    ...
    fun testDepthFeature() {
        val printedTree = File("testData/featureextraction/prettyTree.txt").readText()
    ...
    fun testBranchingFactorOfLeaf() {
        val printedTree = File("testData/featureextraction/prettyLeaf.txt").readText()
        val tree: PrettyNode = restoreFromPrettyPrint(printedTree)!!
    ...
    fun testBranchingFactor() {
        val printedTree = File("testData/featureextraction/prettyTree_bf.txt").readText()
        val tree: PrettyNode = restoreFromPrettyPrint(printedTree)!!
    ...
    fun testCompressiblePathLengths() {
        val printedTree = File("testData/featureextraction/prettyTree_paths.txt").readText()
        val tree: PrettyNode = restoreFromPrettyPrint(printedTree)!!
