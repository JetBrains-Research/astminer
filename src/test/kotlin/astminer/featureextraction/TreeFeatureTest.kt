...
class TreeFeatureTest {
    ...
    fun testDepthFeature() {
        val printedTree = File("src/test/resources/testData/featureextraction/prettyTree.txt").readText()
    ...
    fun testBranchingFactorOfLeaf() {
        val printedTree = File("src/test/resources/testData/featureextraction/prettyLeaf.txt").readText()
        val tree: PrettyNode = restoreFromPrettyPrint(printedTree)!!
    ...
    fun testBranchingFactor() {
        val printedTree = File("src/test/resources/testData/featureextraction/prettyTree_bf.txt").readText()
        val tree: PrettyNode = restoreFromPrettyPrint(printedTree)!!
    ...
    fun testCompressiblePathLengths() {
        val printedTree = File("src/test/resources/testData/featureextraction/prettyTree_paths.txt").readText()
        val tree: PrettyNode = restoreFromPrettyPrint(printedTree)!!
