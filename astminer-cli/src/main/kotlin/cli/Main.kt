...
fun main(args: Array<String>) {
    if (args.isEmpty()) {
        println("""
             You should specify the task as the first argument ("preprocess", "parse", or "code2vec").
        ...
        return when (args[0]) {
            ...
            else -> throw Exception("The first argument should be task's name: either 'preprocess', 'parse', or 'code2vec'")
        }
    }
}
